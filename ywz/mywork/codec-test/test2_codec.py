...
#python test2_codec.py -d "/home/ywz/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1
#cpu版
...
def test_epoch(epoch, test_dataloader, model, criterion):
    ...
    with torch.no_grad():
        for d in test_dataloader:
            ...
            print("network y2hat",out_net['y2_hat'])
            ...
            # raise ValueError("stop")
            print("dec y2_hat",out_net['y2_hat'])
