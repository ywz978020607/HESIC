# test2_joint.py PSNR计算后再平均
# 单gpu版  和训练代码一样，只是把训练部分注释
#python test2_joint.py -d "/home/sharklet/database/aftercut512"  --seed 0 --cuda 0 --patch-size 512 512 --batch-size 1 --test-batch-size 1
#cpu版
#python test2_joint.py -d "/home/sharklet/database/aftercut512"  --seed 0  --patch-size 512 512 --batch-size 1 --test-batch-size 1
import argparse
import math
import random
import shutil
